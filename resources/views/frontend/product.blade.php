                    ...
                    <div class="hero__search">
                        ...
                        <div class="hero__search__phone">
                            <div class="hero__search__phone__icon">
                                <a href="tel:0329622625"><i class="fa fa-phone"></i></a>
                            </div>
                            <div class="hero__search__phone__text">
                                <h5>(+84) 32 9622 625</h5>
                                <span>CSKH 24/7</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="sidebar__item">
                            ...
                            <div class="sidebar__item__size">
                                @foreach ($cate as $key => $value_cate)
                                    @foreach ($value_cate as $key2 => $value)
                                        <label for="large">
                                            {{ $value->category_name }}
                    ...
                    <div class="product__discount">
                        ...
                        <div class="row">
                            <div class="product__discount__slider owl-carousel">
                                @foreach ($sale as $key => $sale_value)
                                    <div class="col-lg-4">
                                        <div class="product__discount__item">
                                            ...
                                            <div class="product__discount__item__text">
                                                <span>{{ $sale_value->product->brand_name }}</span>
                                                <h5><a href="#"></a>{{ $sale_value->product->product_name }}</h5>
                                                <div class="product__item__price">
                                                    {{ number_format($sale_value->newprice) }}<span>
                                                        {{ number_format($sale_value->product->product_price) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <h5>{{ number_format($value->product_price) }}</h5>
                                    </div>
                                </div>
                            </div>
                        @endforeach
