                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__option">
                            ...
                            <a href="{{ asset('/trang-chu/san-pham') }}">Sản phẩm</a>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large" src="{{ asset($result->product_img) }}"
                                alt="Đang tải hình ảnh">
                        </div>
                        <div class="product__details__pic__slider owl-carousel">
                            @foreach ($getGallery as $key => $value)
                                <img data-imgbigurl="{{ asset($value->url) }}"
                                    src="{{ asset($value->url) }}" alt="Đang tải hình ảnh">
                            @endforeach
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">{{ number_format($result->product_price) }}</div>
