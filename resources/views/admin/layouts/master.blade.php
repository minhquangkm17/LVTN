...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- calendar -->
    <link rel="stylesheet" href="{{ asset('public/admin/css/monthly.css') }}" type="text/css" />
    <!-- //calendar -->
    <!-- //font-awesome icons -->
    ...
    <!-- ckeditor -->
    <script src="{{ asset('public/admin/js/jquery-3.5.0.min.js') }}"></script>
    ...
    <section id="container">
        ...
        <div class="footer">
            <div class="wthree-copyright">
                <p style="text-align: center">© 2022 Visitors. All rights reserved || JK SHOP</p>
            </div>
        </div>
        <!-- / footer -->
    </section>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function loadGallery() {
                ...
                $.ajax({
                    url: "{{ asset('admin/product/select-gallery') }}",
                    method: "POST",
                    data: {
            ...
            $('#file').change(function() {
                ...
                if (files.length > 5) {
                    error += '<span class="error">Chèn tối đa 5 ảnh</span>';
                } else if (files.length == '') {
                    error += '<span class="error">Chèn tối thiểu 1 ảnh</span>';
                } else if (files.size() > 5000000) {
                    error += '<span class="error">Chèn ảnh tối đa 5Mb</span>';
                }
