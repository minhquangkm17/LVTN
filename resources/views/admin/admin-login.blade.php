...
<head>
    <title>Login Admin JK Shop</title>
    ...
    <div class="log-w3">
        <div class="w3layouts-main">
            ...
            <form action="{{ route('admin.dashboard') }}" method="POST">
                {{ csrf_field() }}
                <input type="email" class="ggg" name="mail" placeholder="E-MAIL" required="">
            ...
            <p>Liên hệ người quản lý trang Web nếu không nhớ mật khẩu!</p>
            {{-- <p>Bạn không <a href="registration.html">Create an account</a></p> --}}
        </div>
    </div>
