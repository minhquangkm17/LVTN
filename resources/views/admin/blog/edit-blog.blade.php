            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        @endif
                        <form role="form" action="{{ URL::to('admin/blog/postedit/'.$result->id.'')}}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" onkeyup="ChangeToSlug()" value="{{$result->post_title}}" name="title" class="form-control" id="title">
                            </div>
                            <div class="form-group">
                                <label for="slug">Đường dẫn</label>
                                <input type="text" name="slug" value="{{$result->post_slug}}" class="form-control" id="slug">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="blog_description">{{$result->post_description}}</textarea>
                            </div>
                                <div class="form-group">
                                @error('blog_img')
                                    <span style="color:red">{{ $message }}</span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" value="{{$result->post_img}}" name="post_img" class="form-control" id="blog_img">
                            </div>
                            <div class="form-group">
                                @error('blog_content')
                                    <span style="color:red">{{ $message }}</span>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="blog_content" name="post_content">{{$result->post_content}}</textarea>
                            </div>
